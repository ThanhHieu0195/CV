<div class="col-md-4 profile">
    ...
    <div class="row">
        <div class="session">
            <ul class="basic-profile">
                ...
                <li style="position: relative">
                    ...
                    <h4 style="padding-left: 60px;">606/49/11, Đường 3/2, Phường 14, Quận 10, TP. Hồ Chí Minh</h4>
                </li>
            </ul>
        </div>
        <div class="session">
            <h3 class="title-line">Kỹ Năng</h3>
            <div class="content">
                <!--            item-->
                <div class="item-skill">
                    <h4>PHP (Wordpress, Lavarel, Yii)</h4>
                    <div class="progress">
        ...
        <div class="session">
            <h3 class="title-line">Sở Thích</h3>
            <ul>
                <li><h4>Đọc tin tức</h4></li>
                <li><h4>Cập nhật công nghệ</h4></li>
                <li><h4>Nói chuyện chia sẽ kinh nghiệm</h4></li>
                <li><h4>Nghe nhạc</h4></li>
                <li><h4>Xem Anime</h4></li>
            </ul>
        </div>
    </div>
</div>