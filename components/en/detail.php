...
Also, I went through many position (frontend, backend, devops) so an overview of the system. Helps analyze and correct judgment
    ...
    <div class="session">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="text-right"><strong>10/2019 - 2021</strong></div>
            </div>
        </div>
        <div class="line"></div>
        ...
        <div class="row">
            <div class="col-md-9">
                <h4 class="item-title">Viralworks</h4>
                <div class="wrap-block">
                    <h4 style="font-size: 20px"><b>Project</b></h4>
                    Cralwer Service
                    <h4><b>Platform</b></h4>
                ...
                <div class="wrap-block">
                    ...
                    - Crawl data user from facebook<br>
                    - Manage KOL, BRAND, ADMIN<br>
                    - Manage campaign
                </div>

            </div>
            <div class="col-md-3">
                <div class="text-right"><strong>07/2018 - 10/2019</strong></div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-9">
                <h4 class="item-title">Freelancer</h4>
                <div class="wrap-block">
                    <h4><b>Platform</b></h4>
